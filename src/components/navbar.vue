    ...
    <b-navbar toggleable="lg" type="dark" variant="info">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          ...
          <router-link class="nav-link" to="/services">Productos</router-link>
          <router-link class="nav-link" to="/servicios">Adopta</router-link>
          <router-link class="nav-link" to="/services">Recomendaciones</router-link>
